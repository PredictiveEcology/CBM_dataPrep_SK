...
The main goal of [CBM_dataPrep_SK](https://github.com/PredictiveEcology/CBM_dataPrep_SK.git) is to match  disturbances with disturbance matrices.
...
![](https://raw.githubusercontent.com/PredictiveEcology/spadesCBM/main/manual/images/SKfireAlluvial.png){fig-align="center" width="700"}
