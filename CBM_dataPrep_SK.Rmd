...
[SpaDES](https://SpaDES.PredictiveEcology.org) was designed for spatially explicit modelling and provides a wide variety of tools to support it. [CBM_dataPrep_SK](https://github.com/PredictiveEcology/CBM_dataPrep_SK.git) is where the processing of the spatially explicit inputs to [spadesCBM](https://github.com/PredictiveEcology/spadesCBM.git) happens. This also makes [CBM_dataPrep](https://github.com/PredictiveEcology/CBM_dataPrep_SK.git) the most idiosyncratic module of the [spadesCBM](https://github.com/PredictiveEcology/spadesCBM.git) as it processes study area and scenario specific data. As our default example, we simulate the managed forests of Saskatchewan (study area), from 1985 to 2011, with disturbances as described in @boisvenue2016 (scenario is the time horizon and the type of disturbances).
...
The user needs to provide study-area specific information, the study area location (e.g., a raster or shapefile), 
